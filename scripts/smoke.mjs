...
const features=[
  ...
  ['shortChars: finalCard.shortDescription.length','copy response short-description telemetry'],
  ['fullChars: finalCard.fullDescription.length','copy response full-description telemetry'],
...
if(!server.includes('functionCall: "auto"')||!server.includes('text2image'))fail('GigaChat built-in text2image invocation missing');else ok('GigaChat built-in text2image invocation present');
