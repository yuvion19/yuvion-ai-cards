...
const features=[
  ...
  ['shortChars: card.shortDescription.length','copy response short-description telemetry'],
  ['fullChars: card.fullDescription.length','copy response full-description telemetry'],
