...
if(!html.includes("new Worker('/local-vision-worker.js?v=10.4.1'"))fail('local vision worker hook missing');else ok('local vision worker hook present');
...
if(!html.includes("local-vision-worker.js?v=10.4.1"))fail('vision worker cache bust missing');else ok('vision worker cache bust present');
